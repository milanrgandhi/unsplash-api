...
function putImage_onServer(newURL){
		
	     
         var base_url = '<?php $protocol.SERVER_HOSTNAME."/".LOCALDIR."/" ?>functions1.php';

		 $.ajax({
				'url' : base_url,
				'type' : 'POST', //the way you want to send data to your URL
				'data' : 'post_url='+newURL,
...
<div class='imgWrapper'>
	...
	<div class='text'>
    <a class="pull-right" href="javascript:;" onclick="putImage_onServer('<?php echo $smallimg ?>');"> <i class="fa fa-download" aria-hidden="true"></a></i>
    </div>
